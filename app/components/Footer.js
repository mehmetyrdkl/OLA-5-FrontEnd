    ...
    <footer>
      <div className="upper_footer">
          ...
          <ul>
            {listItems.map((item, index) => (
              <li
                ...
                className={
                  hoveredItem !== index ? "not_highlighted" : "highlighted"
                }
              >
                <a href="#">{item}</a>
              </li>
        ...
        <div>
          ...
          <h5>BOOK ACCOMMODATION</h5>
          <ul>
            <li>
              Phone: <a href="tel:+4570274274">(+45) 70 274 274</a> press 1
            </li>
            <li>
              Email:
              <a href="mailto:%20booking@comwell.com">
                <u>booking@comwell.com</u>
              </a>
            </li>
          </ul>
          <h5>BOOK CONFERENCE</h5>
          <ul>
            <li>
              Phone: <a href="tel:+4570274274">(+45) 70 274 274</a> press 2
            </li>
            <li>
              Email:
              <a href="mailto:%20konference@comwell.com">
                <u>konference@comwell.com</u>
              </a>
            </li>
          </ul>
          <h5>GENERAL</h5>
          <ul>
            <li>
              <a href="#">Contact Comwells Departments</a>
            </li>
            <li>
